...
type RenderEditable = (props: RenderEditableProps) => React$1.ReactElement;
/**
...
type BasePluginPolicy = {
    ...
    editableProps?: {
        ...
        renderElement?: (props: RenderElementProps) => React$1.ReactElement | undefined;
        renderLeaf?: (props: RenderLeafProps) => React$1.ReactElement | undefined;
        renderPlaceholder?: (props: RenderPlaceholderProps) => React$1.ReactElement;
...
declare function createMarksMethods(editor: Editor): {
    ...
    toggleMark: (args_0: "prismToken" | keyof MarksText, args_1?: "prismToken" | keyof MarksText | undefined, args_2?: {
        at?: slate.Location | null | undefined;
    } | undefined) => void;
    toggleBold: () => void;
    toggleItalic: () => void;
